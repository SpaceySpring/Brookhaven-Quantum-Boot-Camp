print("Rydberg Formula for Hydrogen Spectral Lines but only Pfund and Humphreys")
...
print("Bohr Model for Hydrogen Spectral Lines but only Pfund and Humphreys")
